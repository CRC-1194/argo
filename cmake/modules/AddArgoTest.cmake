...
function(add_argo_test)
  ...
  set(MULTIARGS SOURCES COMPILE_DEFINITIONS COMPILE_FLAGS LABELS CMD_ARGS COMMAND CONDITIONS LINK_LIBRARIES)
  ...
  set_tests_properties(${ADDARGOTEST_NAME} PROPERTIES LABELS "${ADDARGOTEST_LABELS}")
