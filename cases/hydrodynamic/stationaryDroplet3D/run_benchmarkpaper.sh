...
nohup argo-run-study.py interFoam -d benchmark-interFoam -np 16 $JOB_ARG $NUM_CASES > logs.interFoam &
nohup argo-run-study.py interIsoFoam -d benchmark-interIsoFoam -np 16 $JOB_ARG $NUM_CASES > logs.interIsoFoam &
nohup argo-run-study.py interFlow -d benchmark-interFlow -np 16 $JOB_ARG $NUM_CASES > logs.interFlow &
