...
argo-agglomerate-study-data.py benchmark-interFoam-benchmarkpaper_00000_templateCase/postProcessing/velocity_data.csv -p benchmarkpaper.parameter -f stationary_droplet_3D_interFoam
argo-agglomerate-study-data.py benchmark-interIsoFoam-benchmarkpaper_00009_templateCase/postProcessing/velocity_data.csv -p benchmarkpaper.parameter -f stationary_droplet_3D_interIsoFoam
argo-agglomerate-study-data.py benchmark-interFlow-benchmarkpaper_00018_templateCase/postProcessing/velocity_data.csv -p benchmarkpaper.parameter -f stationary_droplet_3D_interFlow
