...
argo-agglomerate-study-data.py benchmark-interIsoFoam-benchmarkpaper_00012_templateCase/postProcessing/interfaceHeight1/0/interface_data.csv -p benchmarkpaper.parameter -f oscillating_wave_2D_interIsoFoam
argo-agglomerate-study-data.py benchmark-interFlow-benchmarkpaper_00024_templateCase/postProcessing/interfaceHeight1/0/interface_data.csv -p benchmarkpaper.parameter -f oscillating_wave_2D_interFlow
