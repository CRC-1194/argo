...
argo-agglomerate-study-data.py benchmark-interFlow-benchmarkpaper_00018_templateCase/postProcessing/velocity_data.csv -p benchmarkpaper.parameter -f translating_droplet_2D_interFlow
