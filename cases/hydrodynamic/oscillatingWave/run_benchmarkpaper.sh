...
argo-create-parameter-study.py benchmarkpaper.parameter -p benchmark-interFoam -v 4 #0-11
argo-create-parameter-study.py benchmarkpaper.parameter -p benchmark-interIsoFoam -v 16 #12-23
