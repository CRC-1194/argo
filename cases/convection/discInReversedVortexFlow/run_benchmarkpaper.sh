...
nohup argo-run-study.py interFoam -d benchmark-interFoam -np 4 > logs.interFoam &
nohup argo-run-study.py interIsoFoam -d benchmark-interIsoFoam -np 4 > logs.interIsoFoam &
