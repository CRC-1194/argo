...
Class
    Foam::pandoraDivNormalIsoRDFCurvature
...
SourceFiles
    pandoraDivNormalIsoRDFCurvature.C
...
/*---------------------------------------------------------------------------*\
                         Class pandoraDivNormalIsoRDFCurvature Declaration
\*---------------------------------------------------------------------------*/

class pandoraDivNormalIsoRDFCurvature
    :
...
public:
    ...
    TypeName ("divNormalIsoRDF");

    // Constructors

    //- Construct from components
    pandoraDivNormalIsoRDFCurvature(const fvMesh& mesh, const dictionary& dict);

    //- Construct as copy
    pandoraDivNormalIsoRDFCurvature(const pandoraDivNormalIsoRDFCurvature&) = default;

    //- Destructor
    virtual ~pandoraDivNormalIsoRDFCurvature() = default;
