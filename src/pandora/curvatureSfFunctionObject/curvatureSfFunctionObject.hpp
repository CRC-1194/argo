...
Class
    Foam::curvatureSfFunctionObject

Description

SourceFiles
    curvatureSfFunctionObjectI.H
    curvatureSfFunctionObject.C
    curvatureSfFunctionObjectIO.C

\*---------------------------------------------------------------------------*/

#ifndef curvatureSfFunctionObject_H
#define curvatureSfFunctionObject_H
...
/*---------------------------------------------------------------------------*\
                         Class curvatureSfFunctionObject Declaration
\*---------------------------------------------------------------------------*/

class curvatureSfFunctionObject
:
...
public:
    ...
    TypeName ("curvatureSfEvaluation");

    // Constructors
    curvatureSfFunctionObject(const word& name, const Time& time, const dictionary& dict);


    //- Destructor
    virtual ~curvatureSfFunctionObject() = default;
...
//#include "curvatureSfFunctionObjectI.H"
