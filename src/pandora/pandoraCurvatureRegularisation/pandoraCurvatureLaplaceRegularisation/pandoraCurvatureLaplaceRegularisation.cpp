...
#include "pandoraCurvatureLaplaceRegularisation.hpp"
...
defineTypeNameAndDebug(pandoraCurvatureLaplaceRegularisation, false);
addToRunTimeSelectionTable(pandoraCurvatureRegularisation, pandoraCurvatureLaplaceRegularisation, Dictionary);


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

pandoraCurvatureLaplaceRegularisation::pandoraCurvatureLaplaceRegularisation(const dictionary& dict)
    :
